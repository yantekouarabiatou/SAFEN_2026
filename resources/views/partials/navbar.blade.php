        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown lang-selector">
                    <button class="btn btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-label="{{ __('messages.language') }}">
                        <span class="me-1">
                            @if(app()->getLocale() === 'fr')
                                🇫🇷
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <a class="dropdown-item {{ app()->getLocale() === 'fon' ? 'active' : '' }}" href="{{ route('lang.switch', 'fon') }}">
                                <span class="me-2">🇧🇯</span>
                                {{ __('messages.fon') }}
                            </a>
                        </li>
                ...
                @auth
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            @if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('artisan'))
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.dashboard') ?? route('dashboard') }}">
