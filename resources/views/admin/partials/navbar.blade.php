    ...
    <ul class="navbar-nav navbar-right">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                <div class="dropdown-header">
                    ...
                    <div class="float-right">
                        <a href="{{ route('dashboard.messages') }}">Voir tout</a>
                    </div>
                </div>
                ...
                <div class="dropdown-footer text-center">
                    <a href="{{ route('dashboard.messages') }}">Voir tous les messages <i class="fas fa-chevron-right"></i></a>
                </div>
            </div>
        </li>
        ...
        <li class="dropdown dropdown-list-toggle">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                ...
                <div class="dropdown-footer text-center">
                    <a href="{{ route('dashboard.notifications') }}">Voir toutes les notifications <i class="fas fa-chevron-right"></i></a>
                </div>
            </div>
        </li>
