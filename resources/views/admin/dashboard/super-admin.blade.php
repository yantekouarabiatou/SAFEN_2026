...
{{-- Alertes urgentes --}}
@if($stats['artisans_pending'] > 0 || $stats['products_pending'] > 0 || $stats['unread_messages'] > 0)
<div class="row mt-4">
    <div class="col-12">
                        ...
                        <div class="alert alert-warning alert-has-icon">
                            ...
                            <div class="alert-body">
                                ...
                                <div class="alert-text">
                                    <strong>{{ $stats['artisans_pending'] }}</strong> artisans en attente d'approbation.
                                    <a href="{{ route('admin.artisans.index', ['status' => 'pending']) }}" class="btn btn-sm btn-warning ml-2">
                                        Vérifier maintenant
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="alert alert-warning alert-has-icon">
                            ...
                            <div class="alert-body">
                                ...
                                <div class="alert-text">
                                    <strong>{{ $stats['products_pending'] }}</strong> produits en attente d'approbation.
                                    <a href="{{ route('admin.products.index', ['status' => 'pending']) }}" class="btn btn-sm btn-warning ml-2">
                                        Vérifier maintenant
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="alert alert-info alert-has-icon">
                            ...
                            <div class="alert-body">
                                ...
                                <div class="alert-text">
                                    <strong>{{ $stats['unread_messages'] }}</strong> messages non lus.
            ...
            <div class="card-wrap">
                ...
                <div class="card-footer">
                    <small>
                        ...
                        +{{ $stats['new_users_week'] }} cette semaine
                    </small>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card card-statistic-1 card-warning">
            ...
            <div class="card-wrap">
                ...
                <div class="card-footer">
                    <small>
                        <span class="text-success">{{ $stats['artisans_approved'] }} approuvés</span> •
                        <span class="text-danger">{{ $stats['artisans_pending'] }} en attente</span>
                    </small>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card card-statistic-1 card-success">
            ...
            <div class="card-wrap">
                ...
                <div class="card-footer">
                    <small>
                        <span class="text-success">{{ $stats['completed_orders'] }} complétées</span> •
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card card-statistic-1 card-info">
            ...
            <div class="card-wrap">
                ...
                <div class="card-footer">
                    <small>
                        {{ number_format($stats['today_revenue'], 0, ',', ' ') }} FCFA aujourd'hui
                    </small>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 text-center">
                        <a href="{{ route('admin.artisans.index', ['status' => 'pending']) }}" class="btn btn-warning btn-icon icon-left btn-lg btn-block mb-3">
                            <i class="fas fa-user-check"></i>
                            <div class="mt-2">Approuver artisans</div>
                            @if($stats['artisans_pending'] > 0)
                            <span class="badge badge-light ml-2">{{ $stats['artisans_pending'] }}</span>
                            @endif
                        </a>
                    </div>

                    <div class="col-md-3 text-center">
                        <a href="{{ route('admin.products.index', ['status' => 'pending']) }}" class="btn btn-warning btn-icon icon-left btn-lg btn-block mb-3">
                            <i class="fas fa-box-check"></i>
                            <div class="mt-2">Approuver produits</div>
                            @if($stats['products_pending'] > 0)
                            <span class="badge badge-light ml-2">{{ $stats['products_pending'] }}</span>
                            @endif
                        </a>
                    </div>

                    <div class="col-md-3 text-center">
                        <a href="{{ route('admin.contacts.index') }}" class="btn btn-info btn-icon icon-left btn-lg btn-block mb-3">
                    ...
                    <div class="col-md-3 text-center">
                        <a href="{{ route('admin.orders.index', ['status' => 'pending']) }}" class="btn btn-danger btn-icon icon-left btn-lg btn-block mb-3">
                            <i class="fas fa-shopping-cart"></i>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="{{ route('admin.artisans.index', ['status' => 'pending']) }}" class="btn btn-warning btn-sm">Tous voir</a>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.artisans.approve', $artisan) }}" class="btn btn-sm btn-success">
