                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br>
                                        <small class="text-muted">{{ $quote->created_at ? $quote->created_at->diffForHumans() : '' }}</small>
                                    </td>
                                    <td>
                                        @php
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <button type="button" 
                                                    ...
                                                    title="Répondre"
                                                    data-toggle="modal"
                                                    data-target="#responseModal{{ $quote->id }}">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="response" rows="4" 
                                                                  placeholder="Détaillez votre proposition..." required></textarea>
                                                    </div>
                                                    <div class="form-group">
