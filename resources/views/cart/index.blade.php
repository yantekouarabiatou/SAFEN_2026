    ...
    <div class="cart-container">
        @if($cart->items->count() > 0)
            <div class="cart-header">
                ...
                <p class="mb-0 opacity-75">{{ $cart->item_count }} article(s) • Tous les produits sont fabriqués sur commande
                </p>
            </div>
                                ...
                                <div class="col-md-2">
                                    <div class="quantity-controls justify-content-center">
                                        ...
                                        <input type="number" class="quantity-input" value="{{ $item->quantity }}"
                                            ...
                                            max="{{ $item->product->max_order_quantity ?? 99 }}" id="quantity-{{ $item->id }}"
                        ...
                        <div class="deposit-alert">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h4 class="mb-0" id="deposit-amount">{{ number_format($totalDeposit, 0, ',', ' ') }} FCFA
                                    </h4>
                                </div>
...
@push('scripts')
    <script>
        ...
        function updateQuantityDirect(itemId) {
            ...
            console.log(`Mise à jour item ${itemId} → quantité ${quantity}`);
            ...
            fetch(`/cart/update/${itemId}`, {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        showToast(data.message || 'Quantité mise à jour', 'success');
                    } else {
