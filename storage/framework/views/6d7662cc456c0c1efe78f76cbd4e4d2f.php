<?php $__env->startSection('title', __('Liste des artisans')); ?>
...
<div class="container">
    <nav class="breadcrumb-wrap">
        <a href="<?php echo e(route('home')); ?>"><i class="bi bi-house-fill me-1"></i> <?php echo e(__('messages.home')); ?></a>
        <span class="sep">/</span>
        <span><?php echo e(__('Liste des Artisans')); ?></span>
    </nav>
</div>
...
<div class="page-header">
    <div class="container d-flex align-items-center justify-content-between flex-wrap gap-3">
        <div>
            <h1><?php echo e(__('artisans.title')); ?></h1>
            <p><?php echo e(__('Liste des artisans')); ?></p>
        </div>
        <a href="<?php echo e(route('admin.artisans.create')); ?>" class="btn-become">
            <i class="bi bi-hammer me-1"></i>
            <?php echo e(__('artisans.become_artisan') ?? 'Devenir artisan'); ?>
            ...
            <form method="GET" action="<?php echo e(route('artisans.index')); ?>">
                ...
                <div class="filter-panel">
                    <p class="filter-title">
                        <i class="bi bi-sliders me-1"></i> <?php echo e(__('messages.filter')); ?>

                    </p>

                    
                    <div class="mb-3">
                        <label class="form-label-custom"><?php echo e(__('messages.search')); ?></label>
                    ...
                    <div class="mb-3">
                        <label class="form-label-custom"><?php echo e(__('artisans.filter_by_craft')); ?></label>
                        <div class="select-wrap">
                            <select name="craft" class="form-select-custom">
                                <option value=""><?php echo e(__('artisans.all_crafts')); ?></option>
                                <?php $__currentLoopData = __('artisans.crafts'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $craft): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(request('craft') == $key ? 'selected' : ''); ?>>
                                        <?php echo e($craft); ?>
                    ...
                    <div class="mb-3">
                        <label class="form-label-custom"><?php echo e(__('artisans.filter_by_city')); ?></label>
                        <div class="select-wrap">
                            <select name="city" class="form-select-custom">
                                <option value=""><?php echo e(__('artisans.all_cities')); ?></option>
                                <?php $__currentLoopData = __('artisans.cities'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(request('city') == $key ? 'selected' : ''); ?>>
                                        <?php echo e($city); ?>
                    ...
                    <?php if(request('latitude') && request('longitude')): ?>
                        <div class="mb-3">
                            <label class="form-label-custom"><?php echo e(__('artisans.radius') ?? 'Rayon (km)'); ?></label>
                            <input type="range" name="radius" class="form-range"
                                   min="5" max="200" step="5"
                                   value="<?php echo e(request('radius', 50)); ?>"
                                   oninput="document.getElementById('rv').textContent=this.value">
                            <p class="radius-label">
                                <i class="bi bi-geo-alt-fill me-1"></i>
                                <span id="rv"><?php echo e(request('radius', 50)); ?></span> km
                            </p>
                        </div>
                    <?php endif; ?>

                    <button type="submit" class="btn-filter">
                        <i class="bi bi-search me-1"></i> <?php echo e(__('messages.filter')); ?>

                    </button>
                    <a href="<?php echo e(route('artisans.index')); ?>" class="btn-reset-filter">
        ...
        <div class="col-lg-9">
            ...
            <div class="results-bar">
                <p class="results-count">
                    <strong><?php echo e($artisans->total()); ?></strong>
                    <?php echo e(__('artisans.found_artisans') ?? 'artisans trouvés'); ?>

                    <span class="badge-approved"><?php echo e(__('artisans.approved') ?? 'Vérifiés'); ?></span>
                </p>
                <div class="view-toggle">
                    <button id="btn-grid" class="active" title="<?php echo e(__('artisans.view_grid')); ?>">
                        <i class="bi bi-grid-3x3-gap-fill"></i>
                    </button>
                    <button id="btn-list" title="<?php echo e(__('artisans.view_list')); ?>">
                        <i class="bi bi-list-ul"></i>
                    </button>
                    <button id="btn-map" title="<?php echo e(__('artisans.view_map')); ?>">
            ...
            <div class="artisans-grid" id="artisans-grid">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $artisans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artisan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="artisan-card"
                         data-lat="<?php echo e($artisan->latitude ?? ''); ?>"
                         data-lng="<?php echo e($artisan->longitude ?? ''); ?>"
                         data-name="<?php echo e(e($artisan->user->name ?? '')); ?>">
                        ...
                        <div class="card-photo">
                            <?php if($photoUrl): ?>
                                <img
                                    ...
                                    alt="Photo de <?php echo e($artisan->user->name); ?>"
                                    loading="lazy"
                                    onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
                                
                                <div class="photo-fallback" style="display:none;"><?php echo e($initial); ?></div>
                            <?php else: ?>
                                <div class="photo-fallback"><?php echo e($initial); ?></div>
                            <?php endif; ?>

                            
                            <span class="badge-craft">
                                <i class="bi bi-tools me-1"></i>
                                <?php echo e($artisan->craft_label); ?>

                            </span>

                            
                            <?php if(request('latitude') && request('longitude') && isset($artisan->distance)): ?>
                                <span class="badge-distance">
                                    <i class="bi bi-cursor-fill me-1"></i>
                                    <?php echo e(round($artisan->distance, 1)); ?> km
                                </span>
                            <?php endif; ?>
                            ...
                            <?php if($artisan->verified): ?>
                                <span class="badge-verified">
                                    ...
                                    <?php echo e(__('artisans.verified')); ?>
                        ...
                        <div class="card-body">
                            <h3 class="artisan-name"><?php echo e($artisan->user->name); ?></h3>

                            <p class="artisan-location">
                                <i class="bi bi-geo-alt-fill me-1"></i>
                                <?php echo e($artisan->city); ?>

                                <?php if($artisan->neighborhood): ?>&bull; <?php echo e($artisan->neighborhood); ?><?php endif; ?>
                            </p>

                            <div class="stars-wrap">
                                <div class="stars">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <i class="bi bi-star-fill star <?php echo e($i <= round($artisan->rating ?? 0) ? 'on' : ''); ?>"></i>
                                    <?php endfor; ?>
                                </div>
                                <span class="rating-count">(<?php echo e($artisan->rating_count ?? 0); ?>)</span>
                            </div>

                            <p class="artisan-bio">
                                <?php echo e($artisan->bio ?? 'Artisan passionné et expérimenté.'); ?>
                        ...
                        <div class="card-footer-actions">
                            <?php if($artisan->whatsapp): ?>
                                <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $artisan->whatsapp)); ?>"
                                   class="btn-wa" target="_blank" rel="noopener" title="Contacter sur WhatsApp">
                                    <i class="bi bi-whatsapp me-1"></i>
                                </a>
                            <?php endif; ?>
                            <a href="<?php echo e(route('artisans.show', $artisan->id)); ?>" class="btn-profile">
                                <i class="bi bi-person-fill me-1"></i>
                                <?php echo e(__('views.view_profile')); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="empty-state">
                        ...
                        <h3><?php echo e(__('views.no_artisans_found')); ?></h3>
                        <p><?php echo e(__('views.modify_search')); ?></p>
                        <a href="<?php echo e(route('artisans.index')); ?>" class="btn-reset-empty">
            ...
            <?php if($artisans->hasPages()): ?>
                <div class="pagination-wrap">
                    <?php echo e($artisans->withQueryString()->links('pagination::bootstrap-5')); ?>

                    <p class="pagination-info">
                        Page <strong><?php echo e($artisans->currentPage()); ?></strong>
                        sur <strong><?php echo e($artisans->lastPage()); ?></strong>
                        &mdash; <strong><?php echo e($artisans->total()); ?></strong> artisans au total
                    </p>
                </div>
            <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SAFEN_2026\resources\views/artisans/vue.blade.php ENDPATH**/ ?>