...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('title', 'TOTCHEMEGNON Bénin'); ?>">
    <meta name="author" content="TOTCHEMEGNON Bénin">

    <title><?php echo $__env->yieldContent('title', 'TOTCHEMEGNON Bénin'); ?></title>

    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="<?php echo e(asset('products/vodoun.jpg')); ?>">
...
<?php /**PATH C:\xampp\htdocs\SAFEN_2026\resources\views/layouts/guest.blade.php ENDPATH**/ ?>